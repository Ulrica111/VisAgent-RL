    ...
    def save_checkpoint(self, local_path: str, hdfs_path: str = None, global_step: int = 0, max_ckpt_to_keep=None):
        ...
        with warnings.catch_warnings():
            ...
            with FSDP.state_dict_type(self.model, StateDictType.SHARDED_STATE_DICT, state_dict_cfg, optim_cfg):
                ...
                # 使用旧版 pickle 序列化，避免 zip 流在满盘/网络盘上出现 inline_container 写失败
                _save_kw = {"_use_new_zipfile_serialization": False}
                torch.save(model_state_dict, model_path, **_save_kw)
                torch.save(optimizer_state_dict, optim_path, **_save_kw)  # TODO: address optimizer is None
                torch.save(extra_state_dict, extra_path, **_save_kw)
